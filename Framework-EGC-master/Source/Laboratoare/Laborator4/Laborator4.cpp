...
void Laborator4::Update(float deltaTimeSeconds)
{
	...
	angularStepOx += deltaTimeSeconds * 5;
	//modelMatrix *= Transform3D::Translate(-3.3f, 0.5f, -1.5f);
	modelMatrix *= Transform3D::Translate(translateX - 2.5f, translateY - 2.0f, translateZ -1.5f);
